  ...
  $( function() {
    $( "#slider-range" ).slider({
      ...
      slide: function( event, ui ) {
        $( "#places1" ).val( ui.values[ 0 ] + "%" );
		$( "#places2" ).val( ui.values[ 1 ] - ui.values[ 0 ] +  "%" );
		$( "#places3" ).val( 100 - ui.values[ 1 ] + "%" );
      }
    });
    $( "#places1" ).val( $( "#slider-range" ).slider( "values", 0 ) + "%");
	$( "#places2" ).val( $( "#slider-range" ).slider( "values", 1 ) - $( "#slider-range" ).slider( "values", 0 )+ "%");
    $( "#places3" ).val( $( "#slider-range" ).slider( "values", 1 ) + "%");	
  } );
